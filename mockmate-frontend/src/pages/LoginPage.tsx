...
export default function LoginPage() {
    return (
        <div
            className="min-h-screen bg-bg-page flex items-center justify-center p-4 relative"
            style={{
        ...
        >
            <div className="w-full max-w-md bg-bg-surface rounded-xl shadow-lg p-10 relative z-10 border border-border">
                ...
                <div className="text-center mb-8 flex flex-col items-center">
                    ...
                    <h1 className="font-display text-[22px] text-text-primary mt-3 font-semibold tracking-tight">
                        MockMate
                    </h1>
